	...
	<div class="span12">
		...
		<div class="block">
			<div class="navbar navbar-inner block-header">
			     <div class="muted pull-left">SNACKS/MEALS</div>
			</div>
								...
								<div class="span10">
									<form method="GET" action="">
										...
										<div class="control-group">
											<div class="controls">
												<input required class="input-xlarge text-center span12 focused" name="attendeeID" type="text">
											</div>
										</div>
		...
		<div class="block">
							<div class="navbar navbar-inner block-header">
								<div class="muted pull-left">RECENTLY ATTENDEES GET THEIR SNACK/MEALS</div>
							</div>
							<div class="block-content collapse in">
								<div class="span1"></div>
								<div class="span10">
