                ...
                <div class="span3" id="sidebar">
				    ...
				    <div class="block">
				            ...
				            <div class="table-toolbar">
                                      ...
                                      <?php
                                      		if(@$_GET['hasbarcode']){
                                      			echo  "<span class='alert alert-error'>This Delegates has already a barcode</span>";
                                      		}
                                      		if(@$_GET['success']){
                                      		echo  "<span class='alert alert-success'>Barcode has been assign to delegate.</span>";
                                      			
                                      		}
                                      		if(@$_GET['saved']){
                                      		echo  "<span class='alert alert-success'>Delegate has been successfully saved!</span>";
                                                ...
                                                <td class="">
		                                            <div class="btn-group pull-right">
													  ...
													  <ul class="dropdown-menu">
														<li><a href="#">Edit</a></li>
														<li><a href="addbarcode.php?id=<?= $dels->del_id .'&name='.$dels->del_fname . $dels->del_lname .'&barcode='.$dels->barcode?>"  data-toggle="modal">Add Barcode</a></li>
													  </ul>
													</div>
                                                </td>
                                            </tr>
